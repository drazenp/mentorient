...
namespace mentorient.Controllers
{
    public class ContactsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,Company,PhoneNumber,Address,ZipCode,Email,Website,Notes")] Contact contact)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,Company,PhoneNumber,Address,ZipCode,Email,Website,Notes")] Contact contact)
        {
            if (id != contact.Id)
            {
                return NotFound();
